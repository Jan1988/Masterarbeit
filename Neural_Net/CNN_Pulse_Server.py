...
if __name__ == '__main__':
    ...
    validation_data_path = os.path.join(validation_data_dir, 'Valid_00076.npy')
    ...
    for file in os.listdir(validation_data_dir):
        ...
        valid_data_X_test, valid_data_y_test = get_test_set(os.path.join(validation_data_dir, file))
